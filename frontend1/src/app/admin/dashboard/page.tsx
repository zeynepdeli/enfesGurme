...
export default function AdminDashboardPage() {
  ...
  const menu = [
    ...
    },
    {
      ...
      desc: "Öne çıkan kartları yönet",
    },
    {
      title: "Bestseller Cards",
      icon: Star,
      href: "/admin/bestseller-cards",
      desc: "En çok satan kartları yönet",
    },
  ];

  return (
    <div className="relative min-h-screen  max-w-[1700px] overflow-hidden bg-[#f6efdd] pt-28 pb-20">
      {/* BACKGROUND */}
      ...
      <div className="relative z-10 container mx-auto px-4">
        {/* HERO HEADER */}
        <div className="mb-12 overflow-hidden rounded-[28px] border border-[#d0bc90] bg-[#efe6cf] p-6 shadow-[0_14px_30px_rgba(120,92,58,0.14),inset_0_1px_2px_rgba(255,255,255,0.55)] md:p-8">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(252,247,236,0.98)_0%,_rgba(250,243,228,0.94)_42%,_rgba(246,236,214,0.86)_68%,_rgba(228,212,176,0.40)_100%)]" />
          ...
          <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-[#5e4734]/70">
                Genel sistem durumunu, ürünleri, siparişleri ve vitrindeki özel
                kart alanlarını buradan yönetebilirsiniz.
              </p>
            </div>
