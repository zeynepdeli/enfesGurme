...
function ShopLayout() {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-[#f6efdd]">
      <div className="pointer-events-none absolute inset-0 z-0 opacity-30 mix-blend-multiply">
        <img
      
          alt=""
          className="fixed h-full w-full object-contain"
           style={{
      ...
      <div className="relative z-10 flex h-screen flex-col pt-32 sm:pt-36 md:pt-40 lg:pt-36 xl:pt-40">
        <div className="mx-auto flex min-h-0 w-full max-w-[1900px] flex-1 overflow-hidden px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 2xl:px-10">
          <div className="grid min-h-0 w-full grid-cols-1 gap-6 lg:grid-cols-[260px_1fr] xl:grid-cols-[300px_1fr] 2xl:grid-cols-[340px_1fr]">
            ...
            <div className="flex min-h-0 min-w-0 flex-col overflow-hidden">
              <div className="shrink-0 border-b border-[#3d3020]/10 ">
                <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                  <h2 className="font-[family-name:var(--font-merienda)]  text-[26px] font-bold  tracking-wide text-[#460d07] sm:text-[30px] md:text-[36px] xl:text-[52px]">
                    {title.toUpperCase()}
                  </h2>
              ...
              <main className="hide-scrollbar min-h-0 flex-1 overflow-y-auto overflow-x-hidden pt-5">
