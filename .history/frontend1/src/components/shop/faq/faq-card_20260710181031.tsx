    ...
    >
      ...
      <div
        className="
          ...
          bg-cover bg-center opacity-[0.08]
          mix-blend-multiply
        "
        style={{
      ...
      >
        {/* İkon arka planı çok açık olursa Chevron kaybolmasın */}
        <span className="absolute inset-0 bg-[#351509]/20" />
