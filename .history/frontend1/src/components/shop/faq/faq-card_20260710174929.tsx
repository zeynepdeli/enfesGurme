  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="absolute right-3 top-3 z-20 flex h-8 w-8 items-center justify-center rounded-full  text-[#f5e7d1] shadow-[0_7px_14px_rgba(71,35,16,0.24),inset_0_1px_1px_rgba(255,255,255,0.35)] transition duration-300 group-hover:rotate-90 sm:h-9 sm:w-9"
