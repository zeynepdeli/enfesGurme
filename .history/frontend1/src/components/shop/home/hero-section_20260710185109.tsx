...
const HERO_SIZES = {
  ...
  layout:
    "relative z-10 mx-auto grid w-full max-w-[1800px] grid-cols-1 items-center md:grid-cols-[70%_62%] lg:grid-cols-[58%_59%] xl:grid-cols-[60%_52%] 2xl:grid-cols-[65%_55%]",
