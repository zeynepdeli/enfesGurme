...
const HERO_SIZES = {
  ...
  layout:
    "relative z-10 mx-auto grid w-full max-w-[1800px] grid-cols-1 items-center md:grid-cols-[70%_62%] lg:grid-cols-[65%_59%] xl:grid-cols-[60%_52%] 2xl:grid-cols-[65%_55%]",
  ...
  textMove:
    "translate-x-0 translate-y-0 md:translate-x-8 md:translate-y-8 lg:translate-x-10 lg:translate-y-12 xl:-translate-x-16 xl:translate-y-14 2xl:translate-x-0 2xl:translate-y-0",
