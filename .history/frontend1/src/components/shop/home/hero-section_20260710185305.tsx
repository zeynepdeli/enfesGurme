...
const HERO_SIZES = {
  ...
  textMove:
    "translate-x-0 translate-y-0 md:translate-x-8 md:translate-y-8 lg:translate-x-0 lg:translate-y-12 xl:-translate-x-16 xl:translate-y-14 2xl:translate-x-0 2xl:translate-y-0",
