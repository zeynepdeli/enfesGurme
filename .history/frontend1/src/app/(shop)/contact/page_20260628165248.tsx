...
function CopperIconCircle({
  ...
  return (
    <div
      className={`relative z-10 flex shrink-0 items-center justify-center rounded-full border border-[#d8bf8a] text-[#2f1a0e] shadow-[0_10px_26px_rgba(80,55,28,0.32)] ${className}`}
      style={{
        background: `
